 ...
 */
router.post('/generate', auth_middleware_1.authMiddleware, qr_controller_1.QRController.generateQRCode);
/**
 * @swagger
 * /api/qr/verify:
 *   post:
 ...
 *         description: Internal server error
 */
router.post('/verify', qr_controller_1.QRController.verifyQRCode);
/**
 * @swagger
 * /api/qr/stats:
 *   get:
 ...
 *         description: Internal server error
 */
router.get('/stats', auth_middleware_1.authMiddleware, qr_controller_1.QRController.getQRStats);
/**
 * @swagger
 * /api/qr/my-codes:
 *   get:
 ...
 *         description: Internal server error
 */
router.get('/my-codes', auth_middleware_1.authMiddleware, qr_controller_1.QRController.getUserQRCodes);
/**
 * @swagger
 * /api/qr/{code}:
 *   delete:
 ...
 *         description: Internal server error
 */
router.delete('/:code', auth_middleware_1.authMiddleware, qr_controller_1.QRController.deactivateQRCode);
/**
 * @swagger
 * /api/qr/session:
 *   get:
 ...
 *         description: Internal server error
 */
router.get('/session', qr_controller_1.QRController.generateSessionQRCode);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
router.post('/verify-session', qr_controller_1.QRController.verifySessionQRCode);
