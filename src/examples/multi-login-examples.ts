...
export class MultiLoginExamples {
  ...
  static registrationValidationError(res: Response) {
  ...
  static duplicateUsername(res: Response) {
    const response = ApiResponse.fail('Username already taken', 409);
    return ApiResponse.send(res, response);
  }

  static duplicateEmail(res: Response) {
    const response = ApiResponse.fail('Email already registered', 409);
    return ApiResponse.send(res, response);
  }

  static duplicatePhone(res: Response) {
    const response = ApiResponse.fail('Phone number already registered', 409);
    return ApiResponse.send(res, response);
  }
}
